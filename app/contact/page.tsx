    ...
    <>
      <section className="py-6 lg:py-20">
        <ContainerBodyLayout maxWidth="xl">
          <MotionDiv
            type="bottomToTop"
            className="rounded-2xl shadow-lg border border-gray-100 p-4"
          >
                    ...
                    <div className="z-[1]">
                      <ul>
                        <li className="text-white flex gap-3 items-center mb-4">
                          <FaPhoneAlt />
                          <Link href={'tel: +8801799920150'}>
                            +8801799920150
                          </Link>
                        </li>
                        <li className="text-white flex gap-3 items-center mb-4">
                          <FaEnvelope />
                          <Link href={'mailto: info@brainsystemltd.com'}>
                            info@brainsystemltd.com
                          </Link>
                        </li>
                        <li className="text-white flex gap-3 items-center mb-4">
                          <FaMapPin />
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="w-full md:w-4/12">
              ...
              <p>
                Email{' '}
                <Link
                  href={'mailto: info@brainsystemltd.com'}
                  className="text-[#046BD2]"
                >
                  info@brainsystemltd.com
                </Link>{' '}
            ...
            <div className="w-full md:w-4/12">
              ...
              <p>
                ...
                <Link href={'tel: +8801799920150'} className="text-[#046BD2]">
                  +8801799920150
                </Link>
              </p>
            </div>
            <div className="w-full md:w-4/12">
              ...
              <p>
                Get in touch with Affirm for media resources at{' '}
                <Link
                  href={'mailto: info@brainsystemltd.com'}
                  className="text-[#046BD2]"
                >
